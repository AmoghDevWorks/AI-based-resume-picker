            ...
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 16 }}>
                {[
                  ...
                  { label: 'Above Threshold', value: results.candidates_above_threshold?.toLocaleString() ?? '—', Icon: IconClock },
                  { label: 'Skipped', value: results.candidates_skipped?.toLocaleString() ?? '—', Icon: IconShield },
                            ...
                            <td style={{ padding: '11px 16px', borderBottom: '1px solid rgba(255,255,255,0.04)', minWidth: 110 }}>
                              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <div style={{ flex: 1, height: 3, borderRadius: 3, background: 'rgba(255,255,255,0.06)', overflow: 'hidden' }}>
                                  <div style={{ height: '100%', width: `${maxScore ? (c.score / maxScore) * 100 : 0}%`, background: '#60a5fa', borderRadius: 3, transition: 'width 0.5s ease' }} />
                                </div>
                                <span style={{ fontSize: 11, fontWeight: 700, color: '#60a5fa', minWidth: 36, textAlign: 'right' }}>
